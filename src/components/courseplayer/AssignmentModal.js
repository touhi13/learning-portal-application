        ...
        open && (
            ...
            >
                <div
                    style={{
                        width: '50%',
                        backgroundColor: 'rgb(8 14 27 / var(--tw-bg-opacity))',
                        position: 'absolute',
                        top: '50%',
                        left: '50%',
                    ...
                    <form className="mt-8 space-y-6" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <div>
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                            >
                                Submit Assignment
                            </button>
                        </div>
