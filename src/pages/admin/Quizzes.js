                        ...
                        <div className="overflow-x-auto mt-4">
                            <table className="divide-y-1 text-base divide-gray-600 w-full">
                                ...
                                <tbody className="divide-y divide-slate-600/50">
                                    ...
                                    <tr>
                                        <td className="table-td">Quiz 3 - What is the difference between null and undefined in
                                            JavaScript?</td>
                                        <td className="table-td">#2 JavaScript Tips and Tricks - JavaScript Job Interview Questions.
                                        </td>
                                        <td className="table-td flex gap-x-2 justify-center">
                                            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                className="w-6 h-6 hover:text-red-500 cursor-pointer transition-all">
